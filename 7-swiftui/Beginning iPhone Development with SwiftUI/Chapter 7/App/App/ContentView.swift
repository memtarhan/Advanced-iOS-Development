...
struct ContentView: View {
    /*
     ...
     NoteThis method of using a Focus State variable with a .focused modifier and a separate control works with Text Fields as well.
     */
    @FocusState var dismissKeyboard: Bool
    @State var message = "Type here"
